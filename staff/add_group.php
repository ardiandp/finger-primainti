...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO `level` (id_level, `level`, aktif) VALUES (%s, %s, %s)",
  ...
  echo "<script>alert('data tersimpan'); document.location='?page=group' </script>";
}
?>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="id_level" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
